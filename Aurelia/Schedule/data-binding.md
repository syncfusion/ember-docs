...
<template>
    <div>
        <ej-schedule id="Schedule1" e-width="100%" e-height="575px" e-appointment-settings.bind="AppointmentList" e-show-location-field="true" e-categorize-settings.bind="CategorizeSettings" e-priority-settings.bind="PrioritySettings" e-current-date="11/07/2015" e-group.bind="Group" e-resources.bind="Resources"></ej-schedule>
    </div>
</template>
...
<template>
    <div>
        <ej-schedule id="Schedule1" e-width="100%" e-height="575px" e-appointment-settings.bind="AppointmentList" e-show-location-field="true" e-categorize-settings.bind="CategorizeSettings" e-current-date="11/07/2015"></ej-schedule>
    </div>
</template>
    ...
    constructor() {
        ...
        this.AppointmentList = {
            dataSource: [{
                ...
                StartTime: '2017/6/5 10:00:00',
                EndTime: '2017/6/5 11:00:00',
                StartTimeZone: 'UTC +05:30',
                EndTimeZone: 'UTC +05:30',
                Description: '',
                AllDay: false,
                ...
                StartTime: '2017/6/4 01:00:00',
                EndTime: '2017/6/4 01:30:00',
                StartTimeZone: 'UTC +05:30',
                EndTimeZone: 'UTC +05:30',
                Description: '',
                AllDay: false,
                ...
                StartTime: '2017/6/3 01:00:00',
                EndTime: '2017/6/3 02:00:00',
                StartTimeZone: 'UTC +05:30',
                EndTimeZone: 'UTC +05:30',
                Description: '',
                AllDay: false,
                ...
                StartTime: '2017/6/1 06:30:00',
                EndTime: '2017/6/1 07:30:00',
                StartTimeZone: 'UTC +05:30',
                EndTimeZone: 'UTC +05:30',
                Description: '',
                AllDay: false,
                ...
                Id: 110,
                Subject: 'MoonShiners',
                StartTime: '2017/6/2 02:00:00',
                EndTime: '2017/6/2 02:30:00',
                StartTimeZone: 'UTC +05:30',
                EndTimeZone: 'UTC +05:30',
                Description: '',
                AllDay: false,
                ...
                StartTime: '2017/5/30 14:00:00',
                EndTime: '2017/5/30 15:30:00',
                StartTimeZone: 'UTC +05:30',
                EndTimeZone: 'UTC +05:30',
                Description: '',
                AllDay: false,
                ...
                Id: 112,
                Subject: 'Close Encounters',
                StartTime: '2017/5/30 03:00:00',
                EndTime: '2017/5/30 03:30:00',
                StartTimeZone: 'UTC +05:30',
                EndTimeZone: 'UTC +05:30',
                Description: '',
                AllDay: false,
                ...
                StartTime: '2017/6/2 04:20:00',
                EndTime: '2017/6/2 05:50:00',
                StartTimeZone: 'UTC +05:30',
                EndTimeZone: 'UTC +05:30',
                Description: '',
                AllDay: false,
                ...
                Id: 115,
                Subject: 'Cash Cab',
                StartTime: '2017/5/30 15:00:00',
                EndTime: '2017/5/30 16:30:00',
                StartTimeZone: 'UTC +05:30',
                EndTimeZone: 'UTC +05:30',
                Description: '',
                AllDay: false,
...
export class Schedule {
    constructor() {
        let dataManager = ej.DataManager({
            url: "http://mvc.syncfusion.com/OdataServices/api/ScheduleData/", // get the required appointments from Web API service
            crossDomain: true // enable cross domain
        });
        this.AppointmentList = {
            dataSource: dataManager,
        };
...
export class Schedule {
    constructor() {
        ...
        this.AppointmentList = {
            dataSource: dataManager // Configure the dataSource with dataManager object
        };
    }
}
...
<template>
    <div>
        <ej-schedule id="Schedule1" e-current-date="11/07/2015" e-enable-load-on-demand="true" e-appointment-settings.bind="AppointmentList"> </ej-schedule>
    </div>
</template>

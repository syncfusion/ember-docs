...
Aurelia frameworkâ€™s template engine and syntaxes can be used within all template supported Syncfusion Aurelia components.

The `ejGrid` widgetâ€™s column template can be rendered as like the below code example.
